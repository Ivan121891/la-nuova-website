...
const packages = [
  ...
  },
  {
    ...
    price: '549',
    original: '690',
    desc: 'A luxurious resurfacing ritual — HydraFacial MD deeply cleanses and infuses antioxidants, followed by a custom medical-grade chemical peel that reveals fresh, luminous skin.',
    items: ['Full HydraFacial MD Session', 'Custom Medical-Grade Chemical Peel', 'Calming Post-Treatment Recovery Mask'],
    popular: false,
    image: 'facial-2.jpg',
  },
  {
